...
This API will filter the input data (JSON) based on some conditions and return few fields

### Testing the API

1. Open any REST Console (a Chrome add-on will do)
2. Select the method as POST
3. Put the input JSON in the Request Payload
4. Make a call and verify the results
